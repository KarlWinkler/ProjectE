...
//					System.out.println(String.format("A: %02X; B): %02X",pixelA>>>24, pixelB>>>24)) ;
	 ...
	 */
	public void calculate2DBounce(TwoDimensionBounce twoDBounce, ActiveSprite sprite, ArrayList<StaticSprite> barriers, double velocityX, double velocityY, long actual_delta_time ) {
